...
const projects: ProjectItem[] = [
  ...
  },
  {
    ...
    category: "backend",
    number: "03",
    badge: "Backend & WebSockets",
    title: "Real Time Chat",
    subtitle: "WebSocket-powered messaging · Sub-100ms delivery · Room-based architecture",
    description:
      "A real-time messaging application with room-based channel isolation, JWT stateless authentication, bcrypt password hashing, persistent MongoDB message histories, and active user typing broadcasts.",
    metrics: "Sub-100ms Delivery · JWT Auth · 50-Msg Cache",
    stack: ["Socket.io", "Node.js", "Express", "MongoDB", "React"],
